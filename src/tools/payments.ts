  ...
  return {
    erply_list_payments: {
      description:
        ...
        "paymentType is not required by the live API, but omitting it returns a small default set even with a wide date range — pass a PAYMENT_TYPE dictionary code for a complete list. " +
